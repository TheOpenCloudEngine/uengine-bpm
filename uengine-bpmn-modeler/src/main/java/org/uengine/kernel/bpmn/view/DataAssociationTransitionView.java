...
import org.uengine.kernel.DataAssociationSequenceFlow;
...
public class DataAssociationTransitionView extends SequenceFlowView {
...
//		symbol.setWidth(200);
//		symbol.setElementClassName(DataAssociationSequenceFlow.class.getName());

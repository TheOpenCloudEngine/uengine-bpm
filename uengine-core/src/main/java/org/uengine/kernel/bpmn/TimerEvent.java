...
//			values={STOP_INSTANCE, PASS_INSTANCE})
	...
	public void fireMessage(String instanceId, Object payload) {
        ProcessManagerFactoryBean processManagerFactoryBean = new ProcessManagerFactoryBean();
        DataSource dataSource = null;
        try {
            ProcessManagerRemote processManager = processManagerFactoryBean.getProcessManager();

var org_uengine_modeling_ElementView = function (objectId, className) {
    ...
    this.setParent = function (elementId, parentId) {
        ...
        //Î∂?Î™®Í? Ï∫îÎ≤Ñ?ä§?óê ?ïÑÏß? Í∑∏Î†§Ïß?Ïß? ?ïä?ïò?ùÑ Í≤ΩÏö∞ ?òà?ïΩ?ùÑ Í±∏Ïñ¥?Üì?äî?ã§.
        if (!parentElement) {
        ...
        //?ûê?ã†?óêÍ≤? ?òà?ïΩ?ù¥ Í±∏Î†§?ûà?äîÍ≤ÉÏù¥ ?ûà?ã§Î©? Í∑∏Î£π?ùÑ Îß∫Îäî?ã§.
    ...
    this.init = function () {
        ...
        //concern Î≥? ?Éâ?ÉÅ ?†Å?ö©?ùÑ ?úÑ?ï¥ by soo
        //?ù¥ Î∂?Î∂ÑÍ≥º
        ...
        if (existElement) {
            ...
            //concern Î≥? color ?†Å?ö© by soo
            //?ù¥ Î∂?Î∂ÑÏùÑ Ï∂îÍ??ïò?ãúÎ©? ?ê† Í≤? Í∞ôÏäµ?ãà?ã§.
            ...
            //3Î≤?. ?ã§?†ú?†Å?úºÎ°? Ï∫îÎ≤Ñ?ä§?óê Í∑∏Î¶º.
        ...
        //Ï∫îÎ≤Ñ?ä§Í∞? Î¶¨Î™®?ä∏ Î™®Îìú?ù¥Í≥? ?îÑÎ°úÌçº?ã∞ Î≥?Í≤ΩÏúºÎ°? ?ù∏?ï¥ ?ÉàÎ°? Í∑∏Î†§Ïß? ?óòÎ¶¨Î®º?ä∏?ùºÍ≤ΩÏö∞ Î∏åÎ°ú?ìúÏ∫êÏä§?ä∏ ?àò?ñâ
